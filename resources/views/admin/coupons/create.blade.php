...
@section('content')
	<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Coupons Create</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            @if (count($errors) > 0)
      ...
      @endif
            {!! Form::open(['route' => 'coupons.store','class'=>'form-horizontal','id'=>'coupon_form']) !!}
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="col-sm-10">
                      {{Form::number ('percent_off','',['step'=>'0.01','class'=>' form-control'])}}
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <div class="col-sm-10">
                      {{Form::number ('no_of_uses','',['class'=>' form-control'])}}
                    </div>
                  </div>
                </div>
